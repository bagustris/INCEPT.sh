# 500 — `locale-gen` — TIER 4 — NICHE/SPECIALIZED

> **20 examples** | This command is specialized/niche. Minimal coverage to establish basic competence.

## Task

Generate exactly **20** training examples for the **`locale-gen`** command in ChatML JSONL format.
...
Cover ALL documented flags and options for `locale-gen`. Think through the full man page.

## Example Output Lines

```jsonl
{"messages": [{"role": "system", "content": "ubuntu 24.04 bash non-root"}, {"role": "user", "content": "<natural language request for locale-gen>"}, {"role": "assistant", "content": "<correct locale-gen command>"}]}
{"messages": [{"role": "system", "content": "fedora 39 zsh non-root"}, {"role": "user", "content": "<different phrasing>"}, {"role": "assistant", "content": "<locale-gen with different flags>"}]}
```
...
- [ ] Natural language is diverse (not just "use locale-gen to...")
