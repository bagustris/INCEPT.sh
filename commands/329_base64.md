# 329 — `base64` — TIER 3 — IMPORTANT COMMON COMMAND

> **100 examples** | This command is widely used in practice but not directly tested in the benchmark.

## Task

Generate exactly **100** training examples for the **`base64`** command in ChatML JSONL format.
...
Cover ALL documented flags and options for `base64`. Think through the full man page.

## Example Output Lines

```jsonl
{"messages": [{"role": "system", "content": "ubuntu 24.04 bash non-root"}, {"role": "user", "content": "<natural language request for base64>"}, {"role": "assistant", "content": "<correct base64 command>"}]}
{"messages": [{"role": "system", "content": "fedora 39 zsh non-root"}, {"role": "user", "content": "<different phrasing>"}, {"role": "assistant", "content": "<base64 with different flags>"}]}
```
...
- [ ] Natural language is diverse (not just "use base64 to...")
