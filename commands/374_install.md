# 374 — `install` — TIER 4 — NICHE/SPECIALIZED

> **20 examples** | This command is specialized/niche. Minimal coverage to establish basic competence.

## Task

Generate exactly **20** training examples for the **`install`** command in ChatML JSONL format.
...
-d -m -o -g -v -D -t --mode --owner --group

Cover ALL documented flags and options for `install`. Think through the full man page.

## Example Output Lines

```jsonl
{"messages": [{"role": "system", "content": "ubuntu 24.04 bash non-root"}, {"role": "user", "content": "<natural language request for install>"}, {"role": "assistant", "content": "<correct install command>"}]}
{"messages": [{"role": "system", "content": "fedora 39 zsh non-root"}, {"role": "user", "content": "<different phrasing>"}, {"role": "assistant", "content": "<install with different flags>"}]}
```
...
- [ ] Natural language is diverse (not just "use install to...")
