# 068 — `free` — TIER 2 — BENCHMARK REINFORCEMENT

> **200 examples** | This command PASSES the benchmark but needs reinforcement to maintain accuracy.

## Task

Generate exactly **200** training examples for the **`free`** command in ChatML JSONL format.
...
-h -b -k -m -g -t -s -c --human --bytes --kibi --mebi --gibi --total --seconds --count --wide

Cover ALL documented flags and options for `free`. Think through the full man page.

## Example Output Lines

```jsonl
{"messages": [{"role": "system", "content": "ubuntu 24.04 bash non-root"}, {"role": "user", "content": "<natural language request for free>"}, {"role": "assistant", "content": "<correct free command>"}]}
{"messages": [{"role": "system", "content": "fedora 39 zsh non-root"}, {"role": "user", "content": "<different phrasing>"}, {"role": "assistant", "content": "<free with different flags>"}]}
```
...
- [ ] Natural language is diverse (not just "use free to...")
