# 457 — `go` — TIER 4 — NICHE/SPECIALIZED

> **20 examples** | This command is specialized/niche. Minimal coverage to establish basic competence.

## Task

Generate exactly **20** training examples for the **`go`** command in ChatML JSONL format.
...
build run test get mod fmt vet install clean doc env version

Cover ALL documented flags and options for `go`. Think through the full man page.

## Example Output Lines

```jsonl
{"messages": [{"role": "system", "content": "ubuntu 24.04 bash non-root"}, {"role": "user", "content": "<natural language request for go>"}, {"role": "assistant", "content": "<correct go command>"}]}
{"messages": [{"role": "system", "content": "fedora 39 zsh non-root"}, {"role": "user", "content": "<different phrasing>"}, {"role": "assistant", "content": "<go with different flags>"}]}
```
...
- [ ] Natural language is diverse (not just "use go to...")
