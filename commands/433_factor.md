# 433 — `factor` — TIER 4 — NICHE/SPECIALIZED

> **20 examples** | This command is specialized/niche. Minimal coverage to establish basic competence.

## Task

Generate exactly **20** training examples for the **`factor`** command in ChatML JSONL format.
...
Cover ALL documented flags and options for `factor`. Think through the full man page.

## Example Output Lines

```jsonl
{"messages": [{"role": "system", "content": "ubuntu 24.04 bash non-root"}, {"role": "user", "content": "<natural language request for factor>"}, {"role": "assistant", "content": "<correct factor command>"}]}
{"messages": [{"role": "system", "content": "fedora 39 zsh non-root"}, {"role": "user", "content": "<different phrasing>"}, {"role": "assistant", "content": "<factor with different flags>"}]}
```
...
- [ ] Natural language is diverse (not just "use factor to...")
