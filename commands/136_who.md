# 136 — `who` — TIER 3 — IMPORTANT COMMON COMMAND

> **100 examples** | This command is widely used in practice but not directly tested in the benchmark.

## Task

Generate exactly **100** training examples for the **`who`** command in ChatML JSONL format.
...
-a -b -d -H -l -p -q -r -s -t -T -u --all --boot --dead --heading --login --process --count --runlevel --short

Cover ALL documented flags and options for `who`. Think through the full man page.

## Example Output Lines

```jsonl
{"messages": [{"role": "system", "content": "ubuntu 24.04 bash non-root"}, {"role": "user", "content": "<natural language request for who>"}, {"role": "assistant", "content": "<correct who command>"}]}
{"messages": [{"role": "system", "content": "fedora 39 zsh non-root"}, {"role": "user", "content": "<different phrasing>"}, {"role": "assistant", "content": "<who with different flags>"}]}
```
...
- [ ] Natural language is diverse (not just "use who to...")
