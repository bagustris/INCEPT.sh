# 166 — `ping6` — TIER 3 — IMPORTANT COMMON COMMAND

> **100 examples** | This command is widely used in practice but not directly tested in the benchmark.

## Task

Generate exactly **100** training examples for the **`ping6`** command in ChatML JSONL format.
...
-c -i -s -W -q -n -I --count --interval

Cover ALL documented flags and options for `ping6`. Think through the full man page.

## Example Output Lines

```jsonl
{"messages": [{"role": "system", "content": "ubuntu 24.04 bash non-root"}, {"role": "user", "content": "<natural language request for ping6>"}, {"role": "assistant", "content": "<correct ping6 command>"}]}
{"messages": [{"role": "system", "content": "fedora 39 zsh non-root"}, {"role": "user", "content": "<different phrasing>"}, {"role": "assistant", "content": "<ping6 with different flags>"}]}
```
...
- [ ] Natural language is diverse (not just "use ping6 to...")
